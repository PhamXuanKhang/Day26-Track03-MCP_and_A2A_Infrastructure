...
On Windows PowerShell, start each service in a separate terminal:
...
│   ├── llm.py                 # get_llm() → ChatOpenAI via OpenAI
...
The model is swappable to any OpenAI chat model by setting `OPENAI_MODEL`.
